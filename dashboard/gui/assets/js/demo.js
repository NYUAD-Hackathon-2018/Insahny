...
//    var testStudent = document.querySelector('#testStudent');
    ...
    var st1 = [00, 90, 50,80,40];
    var st2 = [00, 30, 60,80,100];
    var st3 = [00, 50, 80,80,60];

    $('#updateBtn').click(function(){

        vals = JSON.parse(vals);
            //alert("Vals 0 :"+vals.results[0]);
            st1.push(vals.results[0]);
            st2.push(vals.results[1]);
            st3.push(vals.results[2]);
            //alert("Pushed vals");
...
//bar chart 
 ...
 //alert(quizData.A+" "+quizData.B+" "+quizData.C);
