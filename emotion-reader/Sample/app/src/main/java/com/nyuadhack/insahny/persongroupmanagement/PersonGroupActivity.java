...
public class PersonGroupActivity extends AppCompatActivity {
    ...
    class AddPersonGroupTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                faceServiceClient.createLargePersonGroup(
                        params[0],
                        getString(com.nyuadhack.insahny.R.string.user_provided_person_group_name),
                        getString(com.nyuadhack.insahny.R.string.user_provided_person_group_description_data));
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                GridView gridView = (GridView) findViewById(com.nyuadhack.insahny.R.id.gridView_persons);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nyuadhack.insahny.R.layout.activity_person_group);
        ...
        EditText editTextPersonGroupName = (EditText)findViewById(com.nyuadhack.insahny.R.id.edit_person_group_name);
    ...
    private void initializeGridView() {
        ...
        gridView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                inflater.inflate(com.nyuadhack.insahny.R.menu.menu_delete_items, menu);
                ...
                Button addNewItem = (Button)findViewById(com.nyuadhack.insahny.R.id.add_person);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case com.nyuadhack.insahny.R.id.menu_delete_items:
                        deleteSelectedItems();
                        return true;
                    default:
                        return false;
    ...
    private class PersonGridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = layoutInflater.inflate(com.nyuadhack.insahny.R.layout.item_person, parent, false);
            }
            ...
            if (!faceIdSet.isEmpty()) {
                ...
                ((ImageView)convertView.findViewById(com.nyuadhack.insahny.R.id.image_person)).setImageURI(uri);
            } else {
                Drawable drawable = getResources().getDrawable(com.nyuadhack.insahny.R.drawable.select_image);
                ((ImageView)convertView.findViewById(com.nyuadhack.insahny.R.id.image_person)).setImageDrawable(drawable);
            }

            // set the text of the item
            String personName = StorageHelper.getPersonName(personId, personGroupId, PersonGroupActivity.this);
            ((TextView)convertView.findViewById(com.nyuadhack.insahny.R.id.text_person)).setText(personName);

            // set the checked status of the item
            CheckBox checkBox = (CheckBox) convertView.findViewById(com.nyuadhack.insahny.R.id.checkbox_person);
            if (longPressed) {
