...
public class AddFaceToPersonActivity extends AppCompatActivity {
    ...
    private void setUiAfterDetection(Face[] result, boolean succeed) {
        ...
        if (succeed) {
            ...
            GridView gridView = (GridView) findViewById(com.nyuadhack.insahny.R.id.gridView_faces_to_select);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nyuadhack.insahny.R.layout.activity_add_face_to_person);
    ...
    private class FaceGridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView =
                        layoutInflater.inflate(com.nyuadhack.insahny.R.layout.item_face_with_checkbox, parent, false);
            }
            convertView.setId(position);

            ((ImageView)convertView.findViewById(com.nyuadhack.insahny.R.id.image_face))
